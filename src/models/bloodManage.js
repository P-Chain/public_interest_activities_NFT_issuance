...
bloodManage.statics.newApply = function({index,bloodDate,bloodIss,nickname,username}){ // 신청 문서 생성
    const user = new this({index,bloodDate,bloodIss,nickname,username});
    console.log(user);
    return user.save();
};
